...
//                new CleaningProduct("AP-903", "UNO A","DESENGRASANTES", "MATERIAL 1","BASICA", "Descripción", true,150000,  10, "https://www.avasoluciones.com/uploads/2021/09/910-006127.jpg"),
//                new CleaningProduct("AP-904", "MULTIVERSO","LAVALOZA", "","MATERIAL 2", "BASICA", true,150000, 10, "https://www.avasoluciones.com/uploads/2021/09/910-007.jpg")
//        ));
//
...
//        Map<String, CleaningProduct> productOrderOne = new HashMap<String, CleaningProduct>();
//        Map<String, CleaningProduct> productOrderTwo = new HashMap<String, CleaningProduct>();
//
